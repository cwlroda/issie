        ...
        jsOptions<MenuItemOptions> <| fun invisibleMenu ->
            ...
            invisibleMenu.submenu <-
                [| makeKeyItem "Default" "CmdOrCtrl+S" (fun () -> dispatch KeyboardMsg.CtrlS)
                   makeKeyItem "Default" "CmdOrCtrl+P" (fun () -> dispatch KeyboardMsg.CtrlP)
                   makeKeyItem "Default" "CmdOrCtrl+C" (fun () -> dispatch KeyboardMsg.CtrlC)
                   makeKeyItem "Blue" "Alt+C" (fun () -> dispatch KeyboardMsg.AltC)
                   makeKeyItem "Green" "Alt+V" (fun () -> dispatch KeyboardMsg.AltV)
                   makeKeyItem "Default"  "CmdOrCtrl+D" (fun () -> dispatch KeyboardMsg.CtrlD)
                   makeKeyItem "Red" "Alt+Z" (fun () -> dispatch KeyboardMsg.AltZ)
                   makeKeyItem "Default" "CmdOrCtrl+Z" (fun () -> dispatch KeyboardMsg.CtrlZ)
                   makeKeyItem "Default" "CmdOrCtrl+Shift+S" (fun () -> dispatch KeyboardMsg.CtrlShiftS)
                   makeKeyItem "Default" "CmdOrCtrl+Shift+C" (fun () -> dispatch KeyboardMsg.CtrlShiftC)
                   menuSeparator
